...
print_msg "╚════════════════════════════════════════╝" "$GREEN"
echo ""
print_msg "💡 Tip: Connect to Bluetooth by running python tools/esp32_terminal.py" "$BLUE"
print_msg "💡 Tip: Connect to WiFi SSID specified in SETUP.INI and visit http://192.168.4.1" "$BLUE"
echo ""
